...
public class FileClass {
	...
	public void newFile() {
		// 新建图像
		drawarea.index = 0;
		drawarea.chosenStatus = 3;// 设置默认为随笔画
		drawarea.color = Color.black;// 设置颜色
		drawarea.stroke = 3.0f;// 设置画笔的粗细
	...
	public void saveFile() {
		...
		if (fileName == null || fileName.getName().equals(""))// 文件名不存在时
		{
			...
			try {
				...
				output.writeInt(drawarea.index);

				for (int i = 0; i < drawarea.index; i++) {
