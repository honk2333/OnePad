...
public class DrawPad extends JFrame implements ActionListener {
    ...
    private JToolBar buttonpanel1;//定义按钮面板
    private JToolBar buttonpanel2;
    ...
    private String names[] = {"newfile", "openfile", "savefile", "pen", "line",
            ...
            "delete", "move", "fill","eraser"};// 定义工具栏图标的名称
    ...
    DrawPad(String string) {
        ...
        //工具栏的初始化
        buttonpanel1 = new JToolBar(JToolBar.VERTICAL);//垂直方向
        buttonpanel1.setLayout(new GridLayout(1, 300, 0, 0));
        buttonpanel1.setFloatable(false);//不可浮动
        ...
        for (int i = 0; i < names.length; i++) {
            ...
            buttonpanel1.add(button[i]);
            button[i].setBackground(Color.white);
            if (i < 2) button[i].addActionListener(this);
        ...
        fontpanel.setLayout(new GridLayout(2, 2, 0, 0));
        ...
        con.setLayout(null);
        buttonpanel1.setBounds(0, 0, 1000, 75);//给各工具栏安排位置
        ...
        con.add(buttonpanel1);//将各工具栏添加到主面板内
        con.add(drawarea);
        con.add(startbar);
